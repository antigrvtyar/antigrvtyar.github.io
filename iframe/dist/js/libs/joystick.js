export default class JoyStick{
	constructor(options){
		...
		circle.style.cssText = "position:absolute; bottom:35px; width:80px; height:80px; background:rgba(255, 255, 255, 0.5); border:#D1091E solid 1px; border-radius:50%; right:0; left:0; margin:auto;";
		circle.className = "joystick-mobile";
		const thumb = document.createElement("div");
		thumb.style.cssText = "position: absolute; left: 19px; top: 19px; width: 40px; height: 40px; border-radius: 50%; background: #D1091E;";
