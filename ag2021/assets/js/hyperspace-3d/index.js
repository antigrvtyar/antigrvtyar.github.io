import { calcWindowHeight, calcViewBound } from './util/functions.js';
...
const Hyperspace3D = (options, selector = '#hs') => {
  ...
  const defaultOptions = {
    ...
    blur: {
      ...
      hq: false, // This solves ClearType pixel problem, makes content hq. Unfortunately it is pretty process intense
